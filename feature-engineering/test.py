...
results["df_new"].to_csv("data/mtcars_final.csv", index=False)
...
print(results["fe_summary"])
results["df_new"].to_csv("data/bost_final.csv", index=False)
...
print(results["fe_summary"])
results["df_new"].to_csv("data/tit_final.csv", index=False)
