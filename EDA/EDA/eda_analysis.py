...
description, processed_df = automated_eda_numerical_only(df)
#print(description)
content_input = "I am providing you summary of exploratory data analysis result of a dataset. Can you provide me some meaningful information on only  data quality within exactly 2440 length? Here is the summary" + description 
role_input = "You are a data science expert."
response = qwen(content=content_input, role=role_input)
